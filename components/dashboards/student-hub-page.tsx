...
export default function StudentHubPage({ studentId }: { studentId?: string }) {
  ...
  const handleClassroomCtaComplete = useCallback(() => {
    ...
    playRocketSound();
    router.push(`${basePath}/classroom/${encodeURIComponent(lesson.roomName)}`);
  }, [basePath, ctaLaunchingLesson, playRocketSound, router]);
  ...
  const nextLessonExternalPlatform = getExternalClassPlatform(
    nextLesson?.sessionType,
  );
            ...
            <NextClassPanel
              ...
              action={
                ...
                nextLessonExternalPlatform ? (
                  ...
                  >
                    <a
                      href={nextLessonExternalPlatform.url}
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={playRocketSound}
                    >
                      {t("classroom.goToPlatform", {
                        platform: nextLessonExternalPlatform.name,
                      })}
