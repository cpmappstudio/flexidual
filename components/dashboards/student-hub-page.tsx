        ...
        <div className="flex min-h-0 flex-col gap-4 xl:flex-1 xl:overflow-hidden">
          ...
          <div className="grid gap-5 xl:min-h-0 xl:flex-1 xl:overflow-hidden xl:grid-cols-[minmax(0,1fr)_360px]">
            <div className="contents xl:grid xl:min-h-0 xl:grid-rows-[minmax(260px,280px)_minmax(0,1fr)] xl:gap-5">
              <div className="order-1 grid gap-5 xl:order-none xl:grid-cols-[minmax(240px,0.72fr)_minmax(360px,1.28fr)] xl:min-h-0">
                <section className="flex min-h-0 flex-col rounded-[2rem] bg-card p-4 shadow-lg ring-1 ring-border xl:items-center xl:justify-center xl:text-center">
                  <div className="flex w-full items-center gap-3 text-left xl:flex-col xl:text-center">
                    <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-full border-[4px] border-warning bg-primary/10 shadow-inner sm:h-20 sm:w-20 xl:mb-3 xl:h-28 xl:w-28">
                      {isClerkLoaded ? (
                  ...
                  <div className="mt-4 grid w-full grid-cols-3 gap-2 xl:hidden">
                    <div className="min-w-0 rounded-2xl bg-success/50 px-2 py-2 text-center text-success-foreground">
                    ...
                    <div className="min-w-0 rounded-2xl bg-destructive/25 px-2 py-2 text-center text-destructive">
                      <p className="text-xl font-bold leading-none tabular-nums">
                        {missedSessions}
                      </p>
                      <p className="mt-1 text-[11px] font-semibold leading-tight">
                    ...
                    <div className="min-w-0 rounded-2xl bg-info/50 px-2 py-2 text-center text-info-foreground">
                      <p className="text-xl font-bold leading-none tabular-nums">
                        {upcomingCount}
                      </p>
                      <p className="mt-1 text-[11px] font-semibold leading-tight">
                ...
                <section className="hidden flex-col rounded-[2rem] bg-card p-4 shadow-lg ring-1 ring-border sm:p-5 xl:flex xl:min-h-0">
                  <div>
                  ...
                  <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-3 xl:min-h-0 xl:flex-1">
                    <div className="flex min-h-24 min-w-0 flex-col items-center justify-center rounded-2xl bg-success/60 px-2 py-3 text-center text-success-foreground sm:min-h-28">
                    ...
                    <div className="flex min-h-24 min-w-0 flex-col items-center justify-center rounded-2xl bg-destructive/30 px-2 py-3 text-center text-destructive sm:min-h-28">
                      <div className="flex items-center justify-center gap-2">
                        <p className="text-2xl font-bold leading-none tabular-nums sm:text-3xl">
                          {missedSessions}
                        </p>
                    ...
                    <div className="flex min-h-24 min-w-0 flex-col items-center justify-center rounded-2xl bg-info/60 px-2 py-3 text-center text-info-foreground sm:min-h-28">
                      <div className="flex items-center justify-center gap-2">
                        <p className="text-2xl font-bold leading-none tabular-nums sm:text-3xl">
                          {upcomingCount}
                        </p>
