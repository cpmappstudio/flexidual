...
function printUsage() {
  console.log(
    [
      "",
      "Application Program Backfill",
      "",
      "Usage:",
      "  node scripts/backfill-application-programs.mjs [--execute] [--limit 50] [--output /tmp/report.json]",
      "",
      ...
      "Behavior:",
      "  - Dry-run by default.",
      "  - Associates legacy applications to existing programs by case-insensitive name.",
...
async function main() {
  ...
  const output = getArg(
    args,
    "--output",
    "/tmp/cpca-application-program-backfill.json",
  );
  ...
  const result = await convex.mutation(
    api.legacyMigration.backfillApplicationPrograms,
    {
  ...
  console.log("");
  console.log("Application Program Backfill Summary");
  console.log("====================================");
